...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: zU-q0IBtVG_2/css

import SquareSvgIcon from "./icons/PlasmicIcon__SquareSvg"; // plasmic-import: 2dmfrO0Ovd8i/icon
import SquareCheckFilledSvgIcon from "./icons/PlasmicIcon__SquareCheckFilledSvg"; // plasmic-import: H4WuTlYXIEKg/icon
import SquareMinusSvgIcon from "./icons/PlasmicIcon__SquareMinusSvg"; // plasmic-import: A6UR7eLBlTnR/icon
