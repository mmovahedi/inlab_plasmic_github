...
import sty from "./PlasmicBookmarkIcon.module.css"; // plasmic-import: zrroSsNrWnZg/css
...
export type PlasmicBookmarkIcon__ArgsType = {
  selected2?: boolean;
  onSelected2Change?: (val: string) => void;
  patientId?: number;
  trigerReload?: () => void;
};
  ...
  const stateSpecs: Parameters<typeof useDollarState>[0] = React.useMemo(
    () => [
      ...
      },
      {
        ...
        valueProp: "selected2",
        onChangeProp: "onSelected2Change"
      },
      {
