    ...
    () => [
      ...
      },
      {
        ...
        initFunc: ({ $props, $state, $queries, $ctx }) =>
          (() => {
            try {
              return $state.selectedTab === "bookmark";
            } catch (e) {
              if (
      ...
      >
                    ...
                    {(
                      hasVariant(globalVariants, "screen", "mobileFirst")
                        ...
                        : (() => {
                            try {
                              return (
                                $state.filterWard && $state.patientNumber != ""
                              );
                            } catch (e) {
                              if (
                                e instanceof TypeError ||
                ...
                >
                  ...
                  >
                    {(() => {
                      try {
                        return (
                          $state.filterBookmarked && $state.patientNumber != ""
                        );
                      } catch (e) {
                        if (
                          e instanceof TypeError ||
                  ...
                  <ConditionGuard
                    ...
                    onNotSatisfied={async () => {
                      ...
                      $steps["setLocalBookmarkedList"] =
                        $state.searchbar.value === "" && $state.filterBookmarked
                          ? (() => {
                              const actionArgs = {
                                customFunction: async () => {
                                  return (() => {
                      ...
                      if (
                        ...
                        typeof $steps["setLocalBookmarkedList"] === "object" &&
                        ...
                        $state.searchbar.value == ""
                          ? (() => {
                              const actionArgs = {
                                ...
                                operation: 0,
                                value:
                                  $ctx.fetched_data.data != (null || undefined)
        ...
        {(() => {
          const child$Props = {
            ...
            open: generateStateValueProp($state, ["modalNoticeBanner", "open"]),
            title: (
              <div
                className={classNames(
                  projectcss.all,
          ...
          return (
            ...
            >
              <NewNoticeBanner
                ...
                className={classNames("__wab_instance", sty.newNoticeBanner)}
              ...
              <Button
                ...
                onSelectedChange={(...eventArgs) => {
                  generateStateOnChangeProp($state, ["متوجهشدم2", "selected"])(
                    eventArgs[0]
                  );
                }}
                onSortDeselectedChange={(...eventArgs) => {
